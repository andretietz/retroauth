...
public final class AuthAccountManager2 implements BaseAccountManager {
    ...
    /* public static class AccountChooseDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            AccountManager android = AccountManager.get(getActivity());
            final Account[] accounts = android.getAccountsByType(accountType);
