...
class RetroauthTest {
    ...
    @Mock
    lateinit var provider: TokenProvider<String, String, String, String>

    @Mock
    lateinit var tokenStorage: TokenStorage<String, String, String>

    @Mock
    private lateinit var ownerManager: OwnerManager<String, String, String>
    ...
    fun prepare() {
        ...
        whenever(provider.getTokenType(anyInt())).thenReturn("tokenType")
        whenever(provider.getOwnerType(anyInt())).thenReturn("ownerType")
    }
    ...
    fun userCanceledAuthentication() {
        whenever(ownerManager.createOwner(anyString(), anyString())).thenThrow(AuthenticationCanceledException::class.java)
