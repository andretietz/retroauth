...
public class AccountAuthenticatorActivity extends AppCompatActivity {
	...
	protected void login(String accountType, String tokenType, String username, String password) {
		Bundle userData = new Bundle();
		userData.putString(TokenAccountAuthenticator.PARAM_USER, username);
		userData.putString(TokenAccountAuthenticator.PARAM_PASS, password);
		AccountManager.get(this).addAccount(accountType, tokenType, null, userData, null, null, null);
