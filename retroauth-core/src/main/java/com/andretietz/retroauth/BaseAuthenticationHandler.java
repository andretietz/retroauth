...
//
//public class BaseAuthenticationHandler<ID_TYPE, TOKEN_TYPE> implements AuthenticationHandler<TOKEN_TYPE> {
//
//    private final TokenStorage<ID_TYPE, TOKEN_TYPE> storage;
...
//            TokenStorage<ID_TYPE, TOKEN_TYPE> storage) {
...
//        Token<TOKEN_TYPE> token = storage.getToken(type);
